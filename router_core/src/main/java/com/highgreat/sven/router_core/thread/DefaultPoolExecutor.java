package com.highgreat.sven.router_core.thread;
...
public class DefaultPoolExecutor {
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "HGRouter #" + mCount.getAndIncrement());
        }
    };
    ...
    public static ThreadPoolExecutor newDefaultPoolExecutor(int corePoolSize) {
        ...
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(corePoolSize, corePoolSize, SURPLUS_THREAD_LIFE, TimeUnit.SECONDS, new
