package com.highgreat.sven.router_compiler.utils;
...
public class Consts {
    ...
    public static final ClassName ROUTER = ClassName.get(
            "com.highgreat.sven.router_core", "HGRouter");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "com.highgreat.sven.router_annotation.Route";
    public static final String ANN_TYPE_Extra = "com.highgreat.sven.router_annotation.Extra";

    public static final String IROUTE_GROUP = "com.highgreat.sven.router_core.template.IRouteGroup";
    public static final String IROUTE_ROOT = "com.highgreat.sven.router_core.template.IRouteRoot";
    public static final String IEXTRA = "com.highgreat.sven.router_core.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "com.highgreat.sven.router_core.template.IService";
    ...
    public static final String PROJECT = "HGRouter";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.highgreat.sven.router_core";
